...
import com.yangyi.graduationproject.service.RoleService;
...
public class RoleController {
     ...
     */
    @PreAuthorize("hasPermission('/webpages/admin/role/role_list.html','READ')")
    @ResponseBody
    @RequestMapping("/list")
     ...
     * @param role 角色对象
     */
    @PreAuthorize("hasPermission('/webpages/admin/role/role_list.html','CREATE')")
    @ResponseBody
     ...
     * @param role:要更新的角色对象
     */
    @PreAuthorize("hasPermission('/webpages/admin/role/role_list.html','UPDATE')")
    @ResponseBody
     ...
     * @param ids：权限ids
     */
    @PreAuthorize("hasPermission('/webpages/admin/role/role_list.html','DELETE')")
    @ResponseBody
