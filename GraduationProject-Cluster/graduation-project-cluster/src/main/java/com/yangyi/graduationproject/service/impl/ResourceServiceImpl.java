...
public class ResourceServiceImpl implements ResourceService {
    ...
    private static final String RESOURCE_CACHE="resource";
    private static final String RESOURCES_CACHE="resources";
     ...
     * @return 返回资源对象
     */
    @Cacheable(value = RESOURCE_CACHE, key = "#id")
    @Override
     ...
     * @return
     */
    @Cacheable(value = RESOURCES_CACHE)
    @Override
    ...
    @CacheEvict(value = RESOURCES_CACHE,allEntries = true)
    @Override
    ...
    @CacheEvict(value = RESOURCE_CACHE, key = "#resource.id")
    @Override
    ...
    @CacheEvict(value = {RESOURCE_CACHE,RESOURCES_CACHE}, allEntries = true)
    @Override
