...
import com.yangyi.graduationproject.dao.PermissionMapper;
import com.yangyi.graduationproject.dao.RoleMapper;
import com.yangyi.graduationproject.dao.RolePermissionMapper;
import com.yangyi.graduationproject.entities.Permission;
import com.yangyi.graduationproject.entities.Role;
import com.yangyi.graduationproject.entities.RolePermission;
...
import com.yangyi.graduationproject.service.PermissionService;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    private static final String PERMISSION_CACHE="permission";
     ...
     * @return 返回对应的权限对象
     */
    @Cacheable(value = PERMISSION_CACHE,key = "#id")
    @Override
     ...
     * @return 返回操作成功的个数，0表示操作失败
     */
    @CacheEvict(value = PERMISSION_CACHE,key = "#permission.id")
    @Override
     ...
     * @return 返回操作成功的个数，0表示操作失败
     */
    @CacheEvict(value = {PERMISSION_CACHE,PERMISSIONS_CACHE}, allEntries = true)
    @Transactional
    @Override
