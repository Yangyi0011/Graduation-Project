...
import com.yangyi.graduationproject.dao.LockedIPMapper;
...
public class LockedIPServiceImpl implements LockedIPService {
    ...
    private static final String LOCKED_CACHE="locked";
    private static final String LOCKEDS_CACHE="lockeds";

    /**
     * 通过 id 获取锁定对象
     * @return
     */
    @Cacheable(value = LOCKED_CACHE,key = "#id")
    @Override
     ...
     * @return
     */
    @Cacheable(value = LOCKED_CACHE,key = "#IP")
    @Override
     ...
     */
    @CacheEvict(value = {LOCKEDS_CACHE},allEntries = true)
    @Override
     ...
     * @return 返回操作成功的个数，0表示操作失败
     */
    @CacheEvict(value = {LOCKED_CACHE},key = "#lockedIP.id")
    @Override
     ...
     * @return 返回操作成功的个数，0表示操作失败
     */
    @CacheEvict(value = {LOCKED_CACHE,LOCKEDS_CACHE},allEntries = true)
    @Override
